...
// aboutyou
document.getElementById("aboutyouvalue").innerHTML=localStorage.getItem("addressvalue");
...
//shortinfovalue
document.getElementById("shortinfovalue").innerHTML=localStorage.getItem("shortinfovalue");
...
// document.getElementById("skilldis1").innerHTML=localStorage.getItem("skilldisvalue1");

// //2
// document.getElementById("skill2").innerHTML=localStorage.getItem("skill2value");
// document.getElementById("skilldis2").innerHTML=localStorage.getItem("skilldisvalue2");

// //3

// document.getElementById("skill3").innerHTML=localStorage.getItem("skill3value");
// document.getElementById("skilldis3").innerHTML=localStorage.getItem("skilldisvalue3");

// Techicalskill

document.getElementById("tech1").innerHTML=localStorage.getItem("techskillvalue1");

document.getElementById("tech2").innerHTML=localStorage.getItem("techskillvalue2");
document.getElementById("tech3").innerHTML=localStorage.getItem("techskillvalue3");
document.getElementById("tech4").innerHTML=localStorage.getItem("techskillvalue4");
document.getElementById("tech5").innerHTML=localStorage.getItem("techskillvalue5");
document.getElementById("tech6").innerHTML=localStorage.getItem("techskillvalue6");
// document.getElementById("tech7").innerHTML=localStorage.getItem("techskillvalue7");
// document.getElementById("tech8").innerHTML=localStorage.getItem("techskillvalue8");
// document.getElementById("tech9").innerHTML=localStorage.getItem("techskillvalue9");
...
// document.getElementById("jstartm1").innerHTML=localStorage.getItem("jsmonthvalue1");
document.getElementById("jstarte1").innerHTML=localStorage.getItem("jsyearvalue1");
// document.getElementById("jsendm1").innerHTML=localStorage.getItem("jemonthvalue1");
...
// document.getElementById("jstartm2").innerHTML=localStorage.getItem("jsmonthvalue2");
document.getElementById("jstarte2").innerHTML=localStorage.getItem("jsyearvalue2");
// document.getElementById("jsendm2").innerHTML=localStorage.getItem("jemonthvalue2");
...
// document.getElementById("jstartm3").innerHTML=localStorage.getItem("jsmonthvalue3");
document.getElementById("jstarte3").innerHTML=localStorage.getItem("jsyearvalue3");
// document.getElementById("jsendm3").innerHTML=localStorage.getItem("jemonthvalue3");
...
document.getElementById("cityname1").innerHTML=localStorage.getItem("ecityvalue1");
...
document.getElementById("cityname2").innerHTML=localStorage.getItem("ecityvalue2");
